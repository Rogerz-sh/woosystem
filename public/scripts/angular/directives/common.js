    ...
    app.directive('navBar', function () {
        return {
            ...
            controller: ['$scope', '$http', 'model', function ($scope, $http, model) {
                ...
                $scope.menus = [
                    {url: '/', label: '首页', power: [1,4,5,2,3,6,7,8,9,10,99]},
                    {url: '#', label: '数据管理', power: [1,4,5,2,3,6,7,8,9,10,99], items: [
                        {url: '/company/list', label: '企业库', power: [3,6,7,8,9,10,99]},
                    ...
                    {url: '#', label: '项目管理', power: [1,4,5,2,3,6,7,8,9,10,99], items: [
                        {url: '/hunt/list', label: '项目管理', power: [1,4,5,2,3,6,7,8,9,10,99]},
                        {url: '/team/recent', label: '团队近况', power: [8,9,10]},          //367 see self
                    ]},
                    {url: '#', label: '绩效管理', power: [1,4,5,2,3,6,7,8,9,10,99], items: [
                        {url: '/performance/list', label: '绩效管理', power: [1,4,5,2,3,6,7,8,9,10,99]},
                        {url: '/performance/charts', label: '绩效图表', power: [1,4,5,2,3,6,7,8,9,10,99]},
                    ...
                    {url: '#', label: '财务管理', power: [1,5,6,3,7,9,8,2,10,99], items: [
                            {url: '/finance/pay-notice', label: '付款通知书', power: [1,5,6,3,7,9,8,2,10,99]},
                            {url: '/finance/invoice', label: '开票管理', power: [2,10,99]},
                        ]},
