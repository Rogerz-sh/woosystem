...
@section('content')
    <div class="wrap pos-rel full-height">
        <h1 class="pos-abs margin-top-100"><span class="orange">WooSystem</span> <small>即沃客户申报管理系统 V1.0.0</small></h1>
        <div class="content bg-white">
            <div class="login-box">
                <div class="tab-group">
                    <div class="tabs full-width">
                        <div class="tab full-width active" data-target="login">帐户密码登录</div>
                    </div>
