...
@section('title', '新增职位')
@section('content')
    <div class="wrap bg-white padding-15 margin-top-20 margin-bottom-50 bordered border-color-orange" ng-controller="jobEditController">
        <div class="container-fluid">
            ...
            <div class="row">
                <form name="form" ng-init="loadJobInfo({{$id}})" class="form form-horizontal" onsubmit="return false" novalidate>
                    <blockquote>
                        <p>职位基本信息</p>
                    </blockquote>
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            ...
                            <input type="hidden" ng-model="job.id" value="{{$id}}">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-xs-10 col-xs-offset-2">
                            <button class="btn btn-success col-xs-2" ng-click="saveEditInfo()" ng-disabled="form.$invalid">保存</button>
