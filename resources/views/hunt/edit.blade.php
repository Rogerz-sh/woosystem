                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <div class="input-group">
                                ...
                                <input type="hidden" ng-model="hunt.id">
        ...
        (function () {
            ...
            app.controller('huntController', ['$scope', '$http', function ($scope, $http) {
                ...
                $scope.hunt = {
                    ...
                    name: '{{$hunt->name}}',
                    job_id: '{{$hunt->job_id}}',
                    job_name: '{{$hunt->job_name}}',
                    company_id: '{{$hunt->company_id}}',
                    company_name: '{{$hunt->company_name}}',
                    user: '{{$hunt->user}}',
                    date: '{{$hunt->date}}',
                    price: '{{$hunt->price}}',
                    status: '{{$hunt->status}}',
                ...
                $scope.saveBdInfo = function () {
                    ...
                    //return;
                    $http.post('/hunt/save-edit', {hunt: $scope.hunt}).success(function (res) {
