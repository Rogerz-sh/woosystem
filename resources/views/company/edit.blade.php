...
@section('title', '编辑企业')
@section('content')
    <div class="wrap bg-white padding-15 margin-top-20 margin-bottom-50 bordered border-color-orange" ng-controller="companyEditController">
        <div class="container-fluid">
            ...
            <div class="row">
                <form ng-init="loadCompanyInfo({{$company->id}})" id="form" name="companyForm" action="" class="form form-horizontal" onsubmit="return false" novalidate>
                    <blockquote>
                        <p>基本信息</p>
                    </blockquote>
                    <div class="form-group">
                        ...
                        <div class="col-xs-10">
                            <input type="text" kendo-auto-complete k-options="kendoConfig.companyAutoComplete" ng-model="company.name" class="form-control size-full" required>
                            <input type="hidden" name="id" value="{{$company->id}}" ng-model="company.id">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="col-xs-10 col-xs-offset-2">
                            <button type="submit" ng-click="saveEditInfo()" class="btn btn-primary size-mini" ng-disabled="companyForm.$invalid">提交</button>
